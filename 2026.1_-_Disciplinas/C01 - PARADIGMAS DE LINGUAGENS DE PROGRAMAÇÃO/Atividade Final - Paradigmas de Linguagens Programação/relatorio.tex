...
\begin{itemize}
    \item \textbf{Python (imperativo)} --- permite demonstrar o paradigma procedural com variáveis, laços \texttt{while}, condicionais e funções, sem uso de classes ou funções de alta ordem.
    \item \textbf{Python (orientado a objetos)} --- suporta classes com encapsulamento (\texttt{name mangling}), herança e métodos, sendo uma das linguagens OO mais utilizadas.
    \item \textbf{Python (funcional)} --- oferece \texttt{map}, \texttt{filter}, \texttt{reduce}, lambdas e dicionários imutáveis, permitindo um estilo predominantemente funcional.
    \item \textbf{Prolog (lógico)} --- linguagem declarativa por excelência, baseada em fatos e regras, ideal para demonstrar o paradigma lógico.
\end{itemize}

A escolha de Python para três paradigmas permite uma comparação mais justa, isolando o efeito do paradigma sem a interferência de diferenças sintáticas entre linguagens distintas. Prolog foi mantido por ser a referência natural do paradigma lógico.

% ===================================================================
\section{Parte 1 --- Implementação Imperativa (Python)}
% ===================================================================

\lstinputlisting[style=python, caption={parte1\_imperativo.py}]{parte1_imperativo.py}

\subsection{Saída da Execução}

\begin{lstlisting}[style=output]
======================================================================
RELATÓRIO DE DESEMPENHO ACADÊMICO — VERSÃO IMPERATIVA
======================================================================
...
\begin{lstlisting}[style=output]
======================================================================
RELATÓRIO DE DESEMPENHO ACADÊMICO — VERSÃO ORIENTADA A OBJETOS
======================================================================
Nome         Matrícula    N1     N2     N3     Média    Freq   Situação
----------------------------------------------------------------------
Ana          2024001      8.0    7.5    9.0    8.17     85     Aprovado
...
\begin{lstlisting}[style=output]
======================================================================
RELATÓRIO DE DESEMPENHO ACADÊMICO — VERSÃO FUNCIONAL
======================================================================
Nome         Matrícula    N1     N2     N3     Média    Freq   Situação
----------------------------------------------------------------------
Ana          2024001      8.0    7.5    9.0    8.17     85     Aprovado
