...
\begin{itemize}
    \item \textbf{C (imperativo)} --- linguagem procedural por excelência, com controle explícito de memória, structs, ponteiros e funções. Ideal para demonstrar o paradigma imperativo puro.
